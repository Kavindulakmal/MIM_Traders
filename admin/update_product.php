...
if (isset($_POST['update'])) {
   ...
   $image_01 = htmlspecialchars($_FILES['image_01']['name'], ENT_QUOTES, 'UTF-8'); // Sanitize image name
   ...
   $image_02 = htmlspecialchars($_FILES['image_02']['name'], ENT_QUOTES, 'UTF-8'); // Sanitize image name
   ...
   $image_03 = htmlspecialchars($_FILES['image_03']['name'], ENT_QUOTES, 'UTF-8'); // Sanitize image name
